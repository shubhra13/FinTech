...
| |   **`Company Details`**  | |
| ----------- | ----------- | ----------- |
|Name |**`ACORNS`**|![Acorn_logo](images/acorns-small.png) |
| || 
...
### `Domain of the financial technology`
...
### `Technologies the above additional product or service will utilize and Why?`
    ...
    Their beauty is in simplisity. And the foundation platform is already present. However, they lack a full-powered robo-advisor, deploying algorithms and advanced software to manage a varied portfolio of investments. Acorns is more like robo-advisor meets automated saving tool meets app.
